...
setUsernameTaken(!!data);
 ...
 return () => clearTimeout(timeout);
   ...
   created_at: new Date(),
    ...
    setSubmitting(false);
 if (!error) { alert("Profile saved! Redirecting...");
...
className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:outline-none mb-3"
 ...
 className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:outline-none mb-3"
  ...
  className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:outline-none mb-3"
   >
   <option value="">Select story type</option><option value="Linear">Strong, linear storyline</option>
...
className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:outline-none mb-3"
 ...
 type="text"
 value={addictiveGame}
 onChange={(e) => setAddictiveGame(e.target.value)}
 placeholder="Most addictive game ever played"
 className="w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 text-white focus:outline-none mb-3"
  />
  </div>
